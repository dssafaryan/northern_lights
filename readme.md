...
<body style="Margin: 0; min-width: 300px; padding: 0;">
    <div style="background-color:#7bceeb;">
      <!--[if gte mso 9]>
      <v:background xmlns:v="urn:schemas-microsoft-com:vml" fill="t">
        <v:fill type="tile" src="background.png" color="#7bceeb"/>
      </v:background>
      <![endif]-->
        <table height="100%" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse; border-spacing: 0; mso-table-lspace: 0; mso-table-rspace: 0;">
            <tr>
                <td valign="top" align="left" background="background.png">
                    <div class="body" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; table-layout: fixed; text-align: center;">    
                    <!--[if (gte mso 9)|(IE)]>
                    <table width="660" align="center" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                    <td valign="top" width="660" style="padding-left: 0px; padding-right:0px;">
                    <![endif]-->
                        <table class="layout" cellpadding="0" align="center" style="background-color: #ffffff; border-collapse: collapse; border-spacing: 0; margin: 0 auto; max-width: 660px; mso-table-lspace: 0; mso-table-rspace: 0; width: 100%;">

                            <!-- скрытый preheader -->
                            <span style="font-size:0px;line-height:0;color:#2a2f3b;visibility:hidden; opacity:0;height:0;width:0;mso-hide:all;">Скрытый preheader</span>
                            <!-- конец скрытого preheader -->

                            <!-- контентная область -->
                                <!-- Начало блока - Три колонки -->
<tr>
